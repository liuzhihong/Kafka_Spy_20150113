    ...
    public static class CpuModel implements Serializable{
        ...
        public float getUserCpuUsage() {
            ...
            double userUsage = 100*(double) (this.getUserTime())
                    / (double) (this.getTotalCpuTime());
            return Float.parseFloat(new DecimalFormat("0.00").format(userUsage));
        }
        ...
        public float getSysCpuUsage() {
            ...
            double sysUsage = 100*(double) (this.getSysTime())
                    / (double) (this.getTotalCpuTime());
            return Float.parseFloat(new DecimalFormat("0.00").format(sysUsage));
        }
