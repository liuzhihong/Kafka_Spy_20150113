...
public abstract class Constants {
    ...
    public static final String METRICS_THREAD = "thread";
    public static final String METRICS_CLASSES = "classes";
    ...
    public static final String KEY_SERVICE_ENABLE = "enable";
